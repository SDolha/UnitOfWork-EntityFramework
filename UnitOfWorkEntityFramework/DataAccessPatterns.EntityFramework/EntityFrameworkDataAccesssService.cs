...
namespace DataAccessPatterns.EntityFramework
{
    ...
    public class EntityFrameworkDataAccesssService<TDbContext> : IDataAccesssService, IDisposable where TDbContext : DbContext, new()
    {
        public EntityFrameworkDataAccesssService()
        {
