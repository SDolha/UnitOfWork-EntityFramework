...
namespace SampleApp.DataAccess
{
    ...
    public class SampleDataAccesssService : EntityFrameworkDataAccesssService<SampleDatabaseEntities>, ISampleDataAccesssService, IDataAccessService, IDisposable
    {
